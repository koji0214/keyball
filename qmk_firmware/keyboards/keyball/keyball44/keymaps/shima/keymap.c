...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    XXXXXXX  ,  KC_GRV  , KC_1     , KC_2    , KC_3     , XXXXXXX  ,                                         KC_9     , KC_1     , KC_6     , KC_LBRC  , KC_4     , XXXXXXX  ,
    XXXXXXX  , XXXXXXX  , KC_4     , KC_5    , KC_6     , KC_0     ,                                         KC_NUHS  , KC_MINS  , KC_EQL   , KC_SCLN  , KC_QUOT  , XXXXXXX ,
    XXXXXXX  , MOD_LSFT , KC_7     , KC_8    , KC_9     , KC_LBRC  ,                                         KC_NUHS  ,S(KC_INT1), KC_EQL   ,S(KC_LBRC), KC_RSFT  , XXXXXXX,
